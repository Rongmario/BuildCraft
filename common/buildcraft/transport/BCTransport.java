...
public class BCTransport {
    ...
    static {
        ...
        registerTag("item.pipe.buildcrafttransport.emerald_item").reg("pipe_emerald_item")
            .locale("PipeItemsEmerald");
        registerTag("item.pipe.buildcrafttransport.emerald_fluid").reg("pipe_emerald_fluid")
            .locale("PipeFluidsEmerald");
        registerTag("item.pipe.buildcrafttransport.emerald_power").reg("pipe_emerald_power")
