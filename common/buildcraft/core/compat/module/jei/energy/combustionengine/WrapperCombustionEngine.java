package buildcraft.core.compat.module.jei.energy.combustionengine;
...
public class WrapperCombustionEngine implements IRecipeWrapper {
    ...
    public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        ...
        minecraft.fontRenderer.drawString(" at " + MjAPI.formatRFFromMj(fuel.getPowerPerCycle()) + " RF/t", 0, minecraft.fontRenderer.FONT_HEIGHT, Color.darkGray.getRGB());
        GlStateManager.translate(0, minecraft.fontRenderer.FONT_HEIGHT * 2, 0);
        GlStateManager.scale(.7, .7, 1.0);
        minecraft.fontRenderer.drawString(" total " + MjAPI.formatRFFromMj(fuel.getPowerPerCycle() * fuel.getTotalBurningTime()) + " RF", 1, 2, Color.gray.getRGB());
